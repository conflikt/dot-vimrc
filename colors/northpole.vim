...
exec "hi CursorColumn guifg=NONE guibg=white gui=NONE ctermfg=NONE ctermbg=". s:dark_gray.cterm
exec "hi Cursor guifg=NONE guibg=#aaaaaa gui=NONE ctermfg=NONE ctermbg=241"
...
exec "hi Function guifg=". s:blue.gui ." guibg=NONE gui=underline ctermfg=". s:blue.cterm
